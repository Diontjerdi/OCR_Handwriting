""" Split files into training and test sub-directories with a given proportion.
"""
...
if __name__ == '__main__':
    test_prop = 0.8
    source = r"C:\Users\diontjerdi.TRN\PycharmProjects\InStep\sundries\data\NIST_TRAIN"
    destination = source + "_split" + str(test_prop)
